 ...
 * )) .click(); }
 * 
 * @Given("the user enters the username as {string}") public void
 * theUserEntersTheUsernameAsNAME(String userName) {
 * driver.findElement(By.xpath("//input[@placeholder='Username']"))
 * .sendKeys(userName); }
 * 
 * @Given("the user enters the password as {string}") public void
 * theUserEntersThePasswordAsPASSWORD(String Pasword) {
 * driver.findElement(By.xpath("//input[@placeholder='Password']"))
 * .sendKeys(Pasword); }
 * 
 * @When("the user clicks on the login button") public void
 * theUserClicksOnTheLoginButton() {
 * driver.findElement(By.xpath("//span[text()='Login']")) .click(); }
 * 
 * @Then("the user should be able to login successfully") public void
 * theUserShouldBeAbleToLoginSuccessfully() { String usernamepath
 ...
 * usernamepath)))) .getText(); Assert.assertEquals(UserName, "anandraj"); }
 * 
 * 
 * @Then("the user should not be able to login successfully") public void
 * theUserShouldNotBeAbleToLoginSuccessfully() {
 * 
 * String errMsg =
 * driver.findElement(By.xpath("//mat-error[@id='mat-mdc-error-0']"))
 * .getText(); Assert.assertEquals(errMsg,
