...
public class addToCartSteps extends DriverInstance{
	...
	public void theUserShouldLoginAsAnd(String userName, String Pasword) {
		...
		.click();
		WebElement userNameele=driver.findElement(By.xpath("(//span[@class='mdc-button__label']/child::span)[1]"));
	...
	public void theUserSearchBook(String bookName) {
		...
		driver.findElement(By.cssSelector(".mat-mdc-autocomplete-trigger")).sendKeys(bookName);
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector("#mat-autocomplete-0"))));
	...
	public void theCartPageShouldBeUpdated() {
		String numOFbooks= wait.until(ExpectedConditions.
				visibilityOf(driver.findElement(By.xpath("//span[@id='mat-badge-content-0']")))).getText();
